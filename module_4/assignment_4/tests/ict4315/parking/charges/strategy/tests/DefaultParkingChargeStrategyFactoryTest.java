...
class DefaultParkingChargeStrategyFactoryTest {
    ...
    void testGetStrategyForHourlyLot() {
        ParkingLot hourlyLot = new ParkingLot("LOT1", "Hourly Lot", null, 
    ...
    void testGetStrategyForWeekendFreeLot() {
        ParkingLot weekendFreeLot = new ParkingLot("LOT2", "Weekend Free Lot", null, 
        		new WeekendFreeStrategy(null), 10.0, 200);
        
        ParkingChargeStrategy strategy = strategyFactory.getStrategyFor(weekendFreeLot);
        
        assertTrue(strategy instanceof WeekendFreeStrategy, 
        		"Expected WeekendFreeStrategy for Weekend Free Lot");
    }

    @Test
    void testGetStrategyForGraduationSurchargeLot() {
        ParkingLot graduationLot = new ParkingLot("LOT3", "Graduation Lot", null, 
        		new GraduationSurchargeStrategy(null), 12.0, 150);
        
        ParkingChargeStrategy strategy = strategyFactory.getStrategyFor(graduationLot);
        
        assertTrue(strategy instanceof GraduationSurchargeStrategy, 
        		"Expected GraduationSurchargeStrategy for Graduation Lot");
    }

    @Test
    void testGetStrategyForFlatDailyRateLot() {
        ParkingLot flatDailyLot = new ParkingLot("LOT4", "Flat Daily Rate Lot", null, 
        		new FlatDailyRateStrategy(), 15.0, 300);
    ...
    void testGetStrategyForFlatDailyRateWithCompactDiscountLot() {
        ParkingLot flatDailyWithDiscountLot = new ParkingLot("LOT5", 
        		"Flat Daily Rate with Compact Discount", null, 
        		new FlatDailyRateWithCompactDiscountStrategy(), 10.0, 250);
        
        ParkingChargeStrategy strategy = strategyFactory.getStrategyFor(flatDailyWithDiscountLot);
        
        assertTrue(strategy instanceof FlatDailyRateWithCompactDiscountStrategy, 
        		"Expected FlatDailyRateWithCompactDiscountStrategy for Flat Daily Rate with Discount Lot");
    }
